...
We used the Y-Genome Scan (YGS) approach (Carvalho & Clark, 2013) to identify Y-linked scaffolds or contigs. Detailed instructions are provided in the YGS section of the OligoY repository (https://github.com/isabela42/OligoY) and the Identification_Y-linked_scaffolds.txt of this directory. Important: Use ipda_target-inference_YGSv2.sh  
